...
const seedCourse = async () => {
    try {
        ...
        lessons.push({
            ...
            order: 1,
            type: "reading",
            content: "Learn how the Python interpreter works under the hood."
        });
        ...
        // Lesson 3.5: Logic Visualizer
        lessons.push({
            title: "Interactive Logic Visualizer",
            duration: "10:00",
            order: 4,
            type: "visualizer",
            content: "Step into the 3D logic flow and see how Python makes decisions."
        });
