    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'l1', title: 'Introduction to Java', duration: '45 min', type: 'reading', isPreview: true },
          { id: 'l2', title: 'Variables and Data Types', duration: '60 min', type: 'reading' },
          { id: 'l3', title: 'Control Flow Statements', duration: '55 min', type: 'reading' },
          { id: 'l4', title: 'Object-Oriented Programming Basics', duration: '90 min', type: 'reading' },
        ],
      },
      {
        id: 'm2',
        ...
        lessons: [
          { id: 'l5', title: 'Collections Framework', duration: '75 min', type: 'reading' },
          { id: 'l6', title: 'Exception Handling', duration: '50 min', type: 'reading' },
          { id: 'l7', title: 'Multithreading', duration: '80 min', type: 'reading' },
          { id: 'l8', title: 'Java 8 Features', duration: '70 min', type: 'reading' },
        ],
      },
      {
        id: 'm3',
        ...
        lessons: [
          { id: 'l9', title: 'Introduction to Spring Boot', duration: '60 min', type: 'reading', isPreview: true },
          { id: 'l10', title: 'Dependency Injection', duration: '65 min', type: 'reading' },
          { id: 'l11', title: 'Building REST APIs', duration: '90 min', type: 'reading' },
      ...
      },
      {
        ...
        lessons: [
          { id: 'l13', title: 'JPA and Hibernate', duration: '80 min', type: 'reading' },
          { id: 'l14', title: 'Database Relationships', duration: '70 min', type: 'reading' },
          { id: 'l15', title: 'Query Methods', duration: '55 min', type: 'reading' },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        title: 'Python Basics',
        lessons: [
          { id: 'l1', title: 'Introduction to Python', duration: '40 min', type: 'reading', isPreview: true },
          { id: 'l2', title: 'Variables and Data Types', duration: '50 min', type: 'reading' },
          { id: 'l3', title: 'Functions and Modules', duration: '60 min', type: 'reading' },
        ],
      },
      {
        id: 'm2',
        ...
        lessons: [
          { id: 'l4', title: 'Classes and Objects', duration: '70 min', type: 'reading' },
          { id: 'l5', title: 'Inheritance and Polymorphism', duration: '65 min', type: 'reading' },
      ...
      },
      {
        ...
        lessons: [
          { id: 'l7', title: 'Django Introduction', duration: '55 min', type: 'reading', isPreview: true },
          { id: 'l8', title: 'Models and Views', duration: '80 min', type: 'reading' },
          { id: 'l9', title: 'Templates and Forms', duration: '70 min', type: 'reading' },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'l1', title: 'React Introduction', duration: '50 min', type: 'reading', isPreview: true },
          { id: 'l2', title: 'Components and Props', duration: '60 min', type: 'reading' },
          { id: 'l3', title: 'State and Lifecycle', duration: '70 min', type: 'reading' },
        ],
      },
      {
        id: 'm2',
        ...
        lessons: [
          { id: 'l4', title: 'Node.js Basics', duration: '55 min', type: 'reading' },
          { id: 'l5', title: 'Express Framework', duration: '65 min', type: 'reading' },
          { id: 'l6', title: 'Building REST APIs', duration: '80 min', type: 'reading' },
        ],
      },
      {
        id: 'm3',
        ...
        lessons: [
          { id: 'l7', title: 'MongoDB Introduction', duration: '50 min', type: 'reading', isPreview: true },
          { id: 'l8', title: 'CRUD Operations', duration: '60 min', type: 'reading' },
          { id: 'l9', title: 'Mongoose ODM', duration: '55 min', type: 'reading' },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'l1', title: 'NumPy and Pandas', duration: '70 min', type: 'reading', isPreview: true },
          { id: 'l2', title: 'Data Visualization', duration: '60 min', type: 'reading' },
          { id: 'l3', title: 'Data Cleaning', duration: '55 min', type: 'reading' },
        ],
      },
      {
        id: 'm2',
        ...
        lessons: [
          { id: 'l4', title: 'Supervised Learning', duration: '80 min', type: 'reading' },
          { id: 'l5', title: 'Unsupervised Learning', duration: '75 min', type: 'reading' },
          { id: 'l6', title: 'Model Evaluation', duration: '65 min', type: 'reading' },
        ],
      },
      {
        id: 'm3',
        title: 'Deep Learning',
        lessons: [
          { id: 'l7', title: 'Neural Networks', duration: '90 min', type: 'reading', isPreview: true },
          { id: 'l8', title: 'CNN and RNN', duration: '85 min', type: 'reading' },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'l1', title: 'HTML Structure', duration: '40 min', type: 'reading', isPreview: true },
          { id: 'l2', title: 'Semantic Elements', duration: '45 min', type: 'reading' },
          { id: 'l3', title: 'Forms and Inputs', duration: '50 min', type: 'reading' },
        ],
      },
      {
        id: 'm2',
        title: 'CSS3 Styling',
        lessons: [
          { id: 'l4', title: 'CSS Selectors', duration: '55 min', type: 'reading' },
          { id: 'l5', title: 'Flexbox Layout', duration: '65 min', type: 'reading' },
          { id: 'l6', title: 'CSS Grid', duration: '70 min', type: 'reading' },
        ],
      },
      {
        id: 'm3',
        ...
        lessons: [
          { id: 'l7', title: 'JS Introduction', duration: '50 min', type: 'reading', isPreview: true },
          { id: 'l8', title: 'DOM Manipulation', duration: '60 min', type: 'reading' },
          { id: 'l9', title: 'Events and Interactivity', duration: '55 min', type: 'reading' },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          { id: 'l1', title: 'Introduction to Cloud', duration: '50 min', type: 'reading', isPreview: true },
          { id: 'l2', title: 'AWS Core Services', duration: '70 min', type: 'reading' },
          { id: 'l3', title: 'EC2 and S3', duration: '65 min', type: 'reading' },
        ],
      },
      {
        id: 'm2',
        ...
        lessons: [
          { id: 'l4', title: 'Docker Basics', duration: '60 min', type: 'reading' },
          { id: 'l5', title: 'Docker Compose', duration: '55 min', type: 'reading' },
          { id: 'l6', title: 'Container Orchestration', duration: '70 min', type: 'reading' },
        ],
      },
      {
        id: 'm3',
        title: 'Kubernetes',
        lessons: [
          { id: 'l7', title: 'K8s Architecture', duration: '75 min', type: 'reading', isPreview: true },
          { id: 'l8', title: 'Deployments and Services', duration: '80 min', type: 'reading' },
