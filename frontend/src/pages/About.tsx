                ...
                <div className="max-w-7xl mx-auto">
                    <div className="max-w-3xl">
                        ...
                        <motion.h1
                            ...
                            className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-slate-900 leading-tight mb-8"
                        >
                            Empowering Minds, <br />
                    ...
                    >
                        {stats.map((stat, idx) => (
                            <div key={idx} className="bg-white p-5 sm:p-8 rounded-2xl sm:rounded-[2rem] border border-slate-100 shadow-xl shadow-slate-200/50">
                                <div className="w-12 h-12 rounded-2xl bg-indigo-50 text-indigo-600 flex items-center justify-center mb-6">
                                    <stat.icon className="w-6 h-6" />
                                </div>
                                <h3 className="text-2xl sm:text-4xl font-black text-slate-900 mb-2">{stat.value}</h3>
                    ...
                    <div className="grid md:grid-cols-3 gap-10">
                        {values.map((value, idx) => (
                            <motion.div
                                key={idx}
                                whileHover={{ y: -10 }}
                                className="bg-white p-6 sm:p-10 rounded-2xl sm:rounded-[3rem] border border-slate-100 shadow-lg"
                            >
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black mt-4 mb-8 leading-tight">We're on a mission to democratize skill-building globally.</h2>
                        ...
                        <div className="relative hidden lg:block">
                            <div className="aspect-square rounded-[2rem] sm:rounded-[4rem] bg-gradient-to-br from-indigo-600 to-indigo-800 rotate-6" />
                            <div className="absolute inset-0 aspect-square rounded-[2rem] sm:rounded-[4rem] bg-slate-800 -rotate-3 border-4 border-slate-700 p-6 sm:p-10 flex flex-col justify-end">
